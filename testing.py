...
# new_file_icon = PhotoImage(file='icons/bold.png')
# open_file_icon = PhotoImage(file='icons/bold.png')
# save_file_icon = PhotoImage(file='icons/bold.png')
# cut_icon = PhotoImage(file='icons/bold.png')
# copy_icon = PhotoImage(file='icons/bold.png')
# paste_icon = PhotoImage(file='icons/bold.png')
# undo_icon = PhotoImage(file='icons/bold.png')
# redo_icon = PhotoImage(file='icons/bold.png')
# find_icon = PhotoImage(file='icons/bold.png')
...
root=tk.Tk()
f1 = tk.Frame(padx=1000,pady=-1000, background="red")
